...
| `file_id`      | `file_datetime`     | type       | cycle | m44  | m45  | m46  | m47  |
| `"file_1.did"` | 2019-03-01 12:00:00 | `"sample"` | 1     | 1200 | 1100 | 1000 | 5000 |

to the following output:

| `file_id`      | `file_datetime`     | cycle | s44  | s45  | s46  | s47  | r44  | r45  | r46  | r47  |
| `"file_1.did"` | 2019-03-01 12:00:00 | 1     | 1200 | 1100 | 1000 | 5000 | 1250 | 1100 | 1000 | 5000 |
...
```{r}
detf <- rout %>%
  empirical_transfer_function(genplot = TRUE)
```
