...
#' @importFrom ggplot2 ggplot aes geom_line geom_point scale_x_continuous scale_y_continuous expand_limits facet_grid facet_wrap labs theme_bw theme %+% is.ggplot aes_ stat_summary geom_smooth geom_hline scale_size_manual scale_alpha_manual scale_colour_manual geom_violin scale_shape_manual mean_cl_normal
