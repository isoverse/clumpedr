...
#' @param lambda Isotopic fractionation of ^17^O. Defaults to 0.528, from
#'     Barkan and Luz, 2005.
#' @param D17O TODO: look up in Daëron 2016 what this does again.
#' @references
#' Brand, W. A., Assonov, S. S., & Coplen, T. B. (2010). Correction
#'     for the 17O interference in δ(13C) measurements when analyzing CO2 with
#'     stable isotope mass spectrometry (IUPAC Technical Report). Pure and
#'     Applied Chemistry, 82(8), 1719–1733.
#'     https://doi.org/10.1351/PAC-REP-09-01-05
#' @keywords internal
#' @name default.params
#' @aliases clumpedr.params clumpedr.parameters default.parameters brand.parameters
NULL
